    ...
    for (let j = 0; j < ds.length; j++) {
      ...
      for (let m = 0; m < fields.length; m++) {
        ...
        if (field.field_type === "lookup") {
          relation["relation_id"] = genUUID("relation", 6);
          relation["datastore_id"] = field.lookup_datastore_id;
          re_fields[field.lookup_field_id] = field.field_id;
          relation["fields"] = re_fields;
          await dc.updateOne(
...
function genUUID(prefix, randomLength) {
